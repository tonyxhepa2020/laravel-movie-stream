        ...
        <div v-if="isShowingForm" class="bg-white py-4 px-4 sm:px-6 mt-2 lg:col-span-3 xl:pl-12 shadow overflow-hidden border-b border-gray-200 rounded-lg">
            <div class="max-w-lg mx-auto lg:max-w-none">
                <form class="grid grid-cols-1 row-gap-6 mt-2">
                    ...
                    <div>
                        <label for="created_year" class="sr-only">Created Year</label>
                        <div class="relative rounded-md shadow-sm">
                            <input
                            ...
                            <tr>
                                <th
                                    ...
                                    <div class="flex items-center">
                                        <button class="bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Serie Name</button>
                                    </div>
                                </th>
                                <th
                                    class="px-6 py-3 text-left">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                    <div class="flex justify-around">
                                        <router-link
                                            ...
                                            :to="{ name: 'AdminSeason', params:{ serieId: serie.id }}">Seasons</router-link>
                                        <button @click.prevent="editSerie(serie)" class="text-indigo-600 hover:text-indigo-900">Edit</button>
                                        <button @click.prevent="destroySerie(serie)" class="text-red-600 hover:text-red-900 ml-3">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
